...
app = Flask(__name__,template_folder='C:/Users/AdithiMadduluri/Desktop/Linkedin Scrapper')
        ...
        if company_name:
            try:
                ...
                if company_data:
                    ...
                    cn=company_data.get('name')
                    if employee_range_start>10000:
                        ecr=str(employee_range_start)+'+'
                    else:
                        ecr=str(employee_range_start)+'-'+str(employee_range_end)
                    company_details = {
